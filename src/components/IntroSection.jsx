...
export default function IntroSection() {
  return (
    <div className="reference-content mt-8">
      <section className="p-4 sm:p-5 mb-5" style={{ ...bevelOut, background: "#202224" }}>
        <div className="flex items-center gap-2 mb-2">

          <h2 className="text-[15px] font-bold ">MOD PACK FINDER とは？</h2>
        </div>
        ...
        <p className="text-[13px] mt-3">公開ファイルの対応確認であり、ゲームの起動試験はしていません。<a href="/articles/how-we-build-packs/" className="underline">選定方法と確認範囲</a></p>
      </section>
      ...
      <section className="p-4 sm:p-5 mb-5" style={{ ...bevelOut, background: "#202224" }}>
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-[15px] font-bold ">人気のMOD構成から始める</h2>
        </div>
      ...
      <section className="p-4 sm:p-5 mb-5" style={{ ...bevelOut, background: "#202224" }}>
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-[15px] font-bold ">MOD導入で困ったとき</h2>
        </div>
      ...
      <section className="p-4 sm:p-5" style={{ ...bevelOut, background: "#202224" }}>
        <div className="flex items-center gap-2 mb-3">
